...
# https://t.me/Aladdin_Andijon
# https://t.me/+x8I1seB82AA4YmNi
...
@dp.message_handler(commands='гилам ювдирмокчиман')
async def Order(message: types.Message):
    await bot.send_message(message.from_user.id, 'ассалому алейкум бизи гилам ювиш фабрикамизи танглаганиздан хурсандмиз ', reply_markup=kb_client)
...
async def send_start(message: types.Message):
    try:
        await bot.send_message(message.from_user.id, "Ассалому алайкум \nАладдин гилам ювиш фабрикасига хуш келибсиз \nбизнинг группамизга обуна болинг ва бизнинг чегирмалардан фойдаланинг https://t.me/+x8I1seB82AA4YmNi", reply_markup=kb_client)
        await message.delete()
    except:
        await message.reply('подпишитесь в бот: \nhttps://t.me/bot_AladdinBot')


# @dp.message_handler(commands=['help'])
async def send_help(message: types.Message):
    try:
        await bot.send_message(message.from_user.id, 'Ассалому алейкум \n Сизга кандай ёрдам бера оламиз', reply_markup=kb_client)
        await message.delete()
    except:
        await message.reply('Хамма саволларга бот жавоб беради: \nhttps://t.me/bot_AladdinBot')


def register_hendlers_client(dp: Dispatcher):
    dp.register_message_handler(order_start, commands=['гилам ювдирмокчиман'], state=None)
